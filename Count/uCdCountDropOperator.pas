...
type
  TCdCountDropOperatorFrame = class(TBaseFrame)
    lbl_gdate: TcxLabel;
...
var
  CdCountDropOperatorFrame: TCdCountDropOperatorFrame;
...
procedure TCdCountDropOperatorFrame.btn_refrClick(Sender: TObject);
begin
  inherited;
  q_cd_count.Close;
...
procedure TCdCountDropOperatorFrame.Count(typ, level: string);
var fld : string;
begin
  try
    ...
    if CdCountinputForm.ModalResult=mrok then
    begin
...
constructor TCdCountDropOperatorFrame.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TCdCountDropOperatorFrame.cxButton1Click(Sender: TObject);
begin
  inherited;
  Count('D','O');       //drops, operator
end;

procedure TCdCountDropOperatorFrame.btn_settleClick(Sender: TObject);
var e : integer;
begin
  inherited;
  e := 0;
...
procedure TCdCountDropOperatorFrame.cxButton6Click(Sender: TObject);
begin
  inherited;
...
procedure TCdCountDropOperatorFrame.frx_rpt_cd_countGetValue(
...
procedure TCdCountDropOperatorFrame.GesamtspielberichtTische1Click(Sender: TObject);
begin
  inherited;
...
procedure TCdCountDropOperatorFrame.LiveGameSpieltischabrechnung1Click(
  Sender: TObject);
begin
  inherited;
...
procedure TCdCountDropOperatorFrame.q_cd_countBeforeOpen(DataSet: TDataSet);
begin
  inherited;
