...
type
  TCdCountTipsOperatorFrame = class(TBaseFrame)
    lbl_gdate: TcxLabel;
...
var
  CdCountTipsOperatorFrame: TCdCountTipsOperatorFrame;
...
procedure TCdCountTipsOperatorFrame.btn_refrClick(Sender: TObject);
begin
  inherited;
  q_cd_count.Close;
...
procedure TCdCountTipsOperatorFrame.Count(typ, level: string);
var fld : string;
begin
  try
    ...
    CdCountinputForm.q_cd_count_value.SQL.Text := 'select v.*, (v.'+fld+' * v.multiplier)val, c.name from   '+
                                                  'tbl_cd_count_value v                                     '+
...
constructor TCdCountTipsOperatorFrame.Create(AOwner: TComponent);
begin
  inherited;
...
procedure TCdCountTipsOperatorFrame.cxButton3Click(Sender: TObject);
begin
  inherited;
  Count('T','O');       //tips, operator
end;

procedure TCdCountTipsOperatorFrame.btn_settleClick(Sender: TObject);
var e : integer;
begin
  inherited;
  e := 0;
...
procedure TCdCountTipsOperatorFrame.cxButton6Click(Sender: TObject);
begin
  inherited;
...
procedure TCdCountTipsOperatorFrame.frx_tips_countGetValue(const VarName: string;
  var Value: Variant);
begin
  inherited;
...
procedure TCdCountTipsOperatorFrame.q_cd_countBeforeOpen(DataSet: TDataSet);
begin
  inherited;
