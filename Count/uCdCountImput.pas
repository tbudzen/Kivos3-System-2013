...
uses
  ...
  cxGrid, DBAccess, PgAccess, MemDS, cxLabel;

type
  TCdCountImputForm = class(TfrmBaseDialog)
    lbl_1: TcxLabel;
...
var
  CdCountImputForm: TCdCountImputForm;
...
procedure TCdCountImputForm.q_cd_count_valueAfterPost(DataSet: TDataSet);
begin
  inherited;
