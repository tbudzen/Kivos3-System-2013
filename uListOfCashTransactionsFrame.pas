...
begin
  ...
  // WARNING: <=
    IIf(FromShiftType <> '',
    // 1) Je¿eli kliknêliœmy na Open lub Close Shift:
    '(v.datetime >= ''' + FromDateTimeStrMinus1 + ''')',
    // LastShiftDateTimeByTypeStr
    // 2) Je¿eli kliknêliœmy na transakcjê:
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        // Kategorie systemowe dla wartoœci (system category for system values)
        // s¹ potrzebne w przypadku braku values w ogóle dla podtransakcji
        // lub w przypadku podtransakcji bilansuj¹cej dla kolumny Out

        // 1) Najpierw wstawiamy te kategorie domyœlne dla podtransakcji,
        // które nie maj¹ values
        ...
        begin
          ...
          // Dla ka¿dej podtransakcji sprawdzamy, czy trzeba dodaæ systemow¹ kategoriê
          ...
          begin
            ...
            begin
              ...
              // A) Podtransakcja nie ma w ogóle values
              ...
              // (UWAGA: mo¿e mieæ values u¿ywane w In)
        ...
        // UWAGA: Transakcja bilansuj¹ca te¿ mo¿e mieæ values,
        // Wiêc dodajemy jej te¿ zwyk³e kategorie
      ...
      begin
        ...
        // (jeœli by³y potrzebne)

        // Wartoœci systemowe dla iloœci (system values dla nr)
        // s¹ potrzebne w przypadku braku values w ogóle dla podtransakcji
        // lub w przypadku podtransakcji bilansuj¹cej dla kolumny Out

        // 1) Najpierw wstawiamy te system values
        // dla tych podtransakcji, które nie maj¹ zwyk³ych values
        // oraz/i podtransakcja jest bilansuj¹ca

        // UWAGA: W wypadku gdy podtransakcja jest bilansuj¹ca i nie ma values,
        // a jest w konfiguracji Out wymagaj¹cej wpisania wartoœci po stronie In
        // u¿ywamy jednej systemowej value do wpisania In - Out,
        // natomiast wartoœci In i Out wpisujemy do pól amount_in i amount_out przy value
        ...
        begin
          ...
          begin
            ...
            // Dla ka¿dej podtransakcji sprawdzamy, czy trzeba dodaæ systemow¹ value
            ...
            begin
              ...
              begin
                ...
                // wg wartoœci kategorii i waluty zapisanych w konfiguracji podtransakcji
...
begin
  ...
  begin
    ...
    // je¿eli shift to dajemy domyœlny wydruk dla shiftów
